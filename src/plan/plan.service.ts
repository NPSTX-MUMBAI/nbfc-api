    ...
    try {
      ...
      if(query.status){
        const setToken = await this.plan.SetToken(
          {token : 'cy4TY443TBGA9fphzYznYQ:APA91bEbIO2MflwmkFS0tBg_s3bYykpYIRBRS0PpLbSTp1wVbobu63sjLwbFQUrWDglDaxaT5gwMQ3aOSuyzkqZCVP878H1mLEXkCYX40aoGXFCc1sJ8FgSQyeqE2Wg3NTCu__s_H3Dx'},
        );
      }
